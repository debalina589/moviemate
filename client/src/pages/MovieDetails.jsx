...
const MovieDetails = () => {
  ...
  const { axios, shows, getToken, user, image_base_url, fetchFavoriteMovies, favoriteMovies } = useAppContext();
      ...
      <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <div className="flex items-center flex-wrap gap-4 mt-4">
            ...
            <button className="bg-gray-700 p-2.5 rounded-full transition cursor-pointer active:scale-95 gap-6" onClick={handleFavourite}>
