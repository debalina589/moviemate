        ...
        {Array.from({ length: count }, (_, i) => {
          ...
          return (
            <button
              ...
              className={`h-8 w-8 rounded border border-primary/60 cursor-pointer ${selectedSeats.includes(seatId) && "bg-blue-500 text-white"
                } ${occupiedSeats.includes(seatId) ? "bg-red-500 cursor-not-allowed" : "hover:bg-primary/30"}`}
